        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <form action="{{ route('products.index') }}" method="GET" class="mb-4">
                    ...
                    @if(request('search'))
                        <div class="mt-2">
                            <a href="{{ route('products.index') }}" class="small text-decoration-none text-muted"><i
                                    class="fas fa-times me-1"></i>Limpiar filtros</a>
                        </div>
                    @endif
                </form>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted"
                                                    style="font-size: 0.8rem;">{{ Str::limit($product->description, 30) }}</small>
                                            </div>
                                        </div>
                                    </td>
